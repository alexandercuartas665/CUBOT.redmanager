...
public static class EvolutionWebhookParser
{
    public static ParsedInbound? Parse(JsonElement root)
    {
        ...
        // Los digitos del prefijo del jid son el "phone" que Evolution usa como destinatario al
        // responder — vale tanto para @s.whatsapp.net (E.164 real) como para @lid (identificador
        // de privacidad de WhatsApp). En AMBOS casos WhatsApp acepta esos digitos como destino de
        // outbound, asi que no descartamos ni intentamos resolver a un telefono E.164 alternativo
        // (probamos hacerlo en el commit 93887e4 y rompio ingesta de clientes con privacy on).
