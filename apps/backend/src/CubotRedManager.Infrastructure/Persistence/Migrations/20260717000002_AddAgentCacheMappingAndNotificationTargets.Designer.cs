...
namespace CubotRedManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260717000002_AddAgentCacheMappingAndNotificationTargets")]
    partial class AddAgentCacheMappingAndNotificationTargets
    {
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentCacheLeadMapping", b =>
                {
                    ...
                    b.Property<Guid>("AgentId").HasColumnType("uuid").HasColumnName("agent_id");
                    b.Property<string>("CacheFieldKey").IsRequired().HasMaxLength(80).HasColumnType("character varying(80)").HasColumnName("cache_field_key");
                    ...
                    b.Property<string>("TargetSelector").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)").HasColumnName("target_selector");
                    ...
                    b.HasKey("Id").HasName("pk_ai_agent_cache_lead_mappings");
                    b.HasIndex("AgentId", "CacheFieldKey").IsUnique().HasDatabaseName("ix_ai_agent_cache_lead_mappings_agent_id_cache_field_key");
                    b.HasIndex("TenantId", "AgentId").HasDatabaseName("ix_ai_agent_cache_lead_mappings_tenant_id_agent_id");
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentNotificationTarget", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt").HasColumnType("timestamp with time zone").HasColumnName("created_at");
                    b.Property<Guid?>("CreatedBy").HasColumnType("uuid").HasColumnName("created_by");
                    b.Property<Guid>("FromWhatsAppLineId").HasColumnType("uuid").HasColumnName("from_whats_app_line_id");
                    b.Property<string>("Label").HasMaxLength(100).HasColumnType("character varying(100)").HasColumnName("label");
                    b.Property<int>("SortOrder").HasColumnType("integer").HasColumnName("sort_order");
                    b.Property<string>("TargetKind").IsRequired().HasMaxLength(20).HasColumnType("character varying(20)").HasColumnName("target_kind");
                    b.Property<string>("TargetValue").IsRequired().HasMaxLength(120).HasColumnType("character varying(120)").HasColumnName("target_value");
                    b.Property<Guid>("TenantId").HasColumnType("uuid").HasColumnName("tenant_id");
                    b.Property<DateTimeOffset?>("UpdatedAt").HasColumnType("timestamp with time zone").HasColumnName("updated_at");
                    b.Property<Guid?>("UpdatedBy").HasColumnType("uuid").HasColumnName("updated_by");
                    b.HasKey("Id").HasName("pk_ai_agent_notification_targets");
                    b.HasIndex("AgentId").HasDatabaseName("ix_ai_agent_notification_targets_agent_id");
                    b.HasIndex("FromWhatsAppLineId").HasDatabaseName("ix_ai_agent_notification_targets_from_whats_app_line_id");
                    b.HasIndex("TenantId", "AgentId", "SortOrder").HasDatabaseName("ix_ai_agent_notification_targets_tenant_id_agent_id_sort_order");
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentNotificationTarget", b =>
                {
                    ...
                    b.HasOne("CubotRedManager.Domain.Entities.WhatsAppLine", "FromWhatsAppLine")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ai_agent_notification_targets_whats_app_lines_from_whats_app_line_id");
