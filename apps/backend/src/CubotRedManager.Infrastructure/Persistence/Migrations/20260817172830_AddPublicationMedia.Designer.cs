...
namespace CubotRedManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260817172830_AddPublicationMedia")]
    partial class AddPublicationMedia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgent", b =>
                {
                    ...
                    b.Property<string>("PaymentApiBaseUrl")
                        .HasColumnType("text")
                        .HasColumnName("payment_api_base_url");

                    b.Property<string>("PaymentApiPathTemplate")
                        .HasColumnType("text")
                        .HasColumnName("payment_api_path_template");

                    b.Property<string>("PaymentCatalogContainerName")
                        .HasColumnType("text")
                        .HasColumnName("payment_catalog_container_name");

                    b.Property<string>("PaymentCatalogCountryColumn")
                        .HasColumnType("text")
                        .HasColumnName("payment_catalog_country_column");

                    b.Property<string>("PaymentCatalogNameColumn")
                        .HasColumnType("text")
                        .HasColumnName("payment_catalog_name_column");

                    b.Property<string>("PaymentCatalogProductIdColumn")
                        .HasColumnType("text")
                        .HasColumnName("payment_catalog_product_id_column");
                    ...
                    b.Property<DateTimeOffset?>("PaymentLastPriceSyncAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("payment_last_price_sync_at");

                    b.Property<string>("PaymentResponseUrlPath")
                        .HasColumnType("text")
                        .HasColumnName("payment_response_url_path");

                    b.Property<string>("PaymentTokenEncrypted")
                        .HasColumnType("text")
                        .HasColumnName("payment_token_encrypted");

                    b.Property<DateTimeOffset?>("PaymentTokenExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("payment_token_expires_at");

                    b.Property<DateTimeOffset?>("PaymentTokenExpiryNotifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("payment_token_expiry_notified_at");

                    b.Property<DateTimeOffset?>("PaymentTokenLastVerifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("payment_token_last_verified_at");
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentCacheLeadMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CacheFieldKey")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)")
                        .HasColumnName("cache_field_key");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ai_agent_cache_lead_mappings");

                    b.HasIndex("AgentId", "CacheFieldKey")
                        .IsUnique()
                        .HasDatabaseName("ix_ai_agent_cache_lead_mappings_agent_id_cache_field_key");

                    b.HasIndex("TenantId", "AgentId")
                        .HasDatabaseName("ix_ai_agent_cache_lead_mappings_tenant_id_agent_id");

                    b.ToTable("ai_agent_cache_lead_mappings", (string)null);
                });
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentLineBinding", b =>
                {
                    ...
                    b.HasIndex("TenantId", "WhatsAppLineId", "IsConnected")
                        .IsUnique()
                        .HasDatabaseName("ix_ai_agent_line_bindings_tenant_id_whats_app_line_id_is_conne")
                        .HasFilter("\"is_connected\" = true");

                    b.ToTable("ai_agent_line_bindings", (string)null);
                });

            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentNotificationTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("FromWhatsAppLineId")
                        .HasColumnType("uuid")
                        .HasColumnName("from_whats_app_line_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ai_agent_notification_targets");

                    b.HasIndex("AgentId")
                        .HasDatabaseName("ix_ai_agent_notification_targets_agent_id");

                    b.HasIndex("FromWhatsAppLineId")
                        .HasDatabaseName("ix_ai_agent_notification_targets_from_whats_app_line_id");

                    b.HasIndex("TenantId", "AgentId", "SortOrder")
                        .HasDatabaseName("ix_ai_agent_notification_targets_tenant_id_agent_id_sort_order");

                    b.ToTable("ai_agent_notification_targets", (string)null);
                });
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.ApiToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.PublicationMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_publication_medias");

                    b.HasIndex("PublicationId", "SortOrder")
                        .HasDatabaseName("ix_publication_medias_publication_id_sort_order");

                    b.ToTable("publication_medias", (string)null);
                });
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentCacheLeadMapping", b =>
                {
                    b.HasOne("CubotRedManager.Domain.Entities.AiAgent", "Agent")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ai_agent_cache_lead_mappings_ai_agents_agent_id");
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.AiAgentNotificationTarget", b =>
                {
                    b.HasOne("CubotRedManager.Domain.Entities.AiAgent", "Agent")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ai_agent_notification_targets_ai_agents_agent_id");

                    b.HasOne("CubotRedManager.Domain.Entities.WhatsAppLine", "FromWhatsAppLine")
                        .WithMany()
                        .HasForeignKey("FromWhatsAppLineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ai_agent_notification_targets_whats_app_lines_from_whats_ap");

                    b.Navigation("Agent");

                    b.Navigation("FromWhatsAppLine");
                });
            ...
            modelBuilder.Entity("CubotRedManager.Domain.Entities.PublicationMedia", b =>
                {
                    b.HasOne("CubotRedManager.Domain.Entities.Publication", "Publication")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_publication_medias_publications_publication_id");
